...
#define     PATH_CHATREC_IMAGE              [PATH_DOCUMENT stringByAppendingPathComponent:@"CLChatLocalImages"]
#define     PATH_CHATREC_Record              [PATH_DOCUMENT stringByAppendingPathComponent:@"CLChatRecord"]

#define DEFAULT_CHAT_IMAGENAME @"ChatDefault.jpg"
#define DEFAULT_CHAT_USERHEADER @"ChatUserDefault"

#define CHAT_RECORDFINISH @"ChatRecordFinish"
