...
+ (NSAttributedString *) formatMessageString:(NSString *)text
{
    ...
    for(NSTextCheckingResult *match in resultArray) {
        ...
        //只匹配系统默认表情，其他表情直接发送，不会图文混合
        CLFaceGroup *group = [[[CLFaceHelper sharedFaceHelper] faceGroupArray] objectAtIndex:0];
        for (CLFace *face in group.facesArray) {
