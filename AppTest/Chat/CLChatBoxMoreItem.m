...
@interface CLChatBoxMoreItem ()
@property (nonatomic, strong) UIButton *button;
@property (nonatomic, strong) UILabel *titleLabel;
@end

@implementation CLChatBoxMoreItem

+ (CLChatBoxMoreItem *) createChatBoxMoreItemWithTitle:(NSString *)title imageName:(NSString *)imageName{
    CLChatBoxMoreItem *item = [[CLChatBoxMoreItem alloc] init];
    item.title = title;
